...
function medicionesAldo(N::Int64, tipo::Int64, crecimiento::Float64, phi::Float64)
    ...
    return Esferas.vecinos, Esferas.posiciones, Esferas.radios
                ...
                # N 2radios cr  phi
neigs, pos, rs = medicionesAldo(100, 2, 8e-3, 0.82)
display(neigs)
...
using DelimitedFiles, LightGraphs, GraphIO

DelimitedFiles.writedlm("mat.csv",adjMat(neigs),',')
DelimitedFiles.writedlm("pos.csv",pos,',')
DelimitedFiles.writedlm("rs.csv",rs,',')
